...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     ~~~~~Obtención de los datos subidos a la base de datos~~~
     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
<?php
include_once('conn/conn.php');
$consulta=laconsulta();
if ($documentos=$consulta->fetch_assoc()) {
   $tituloPDF=utf8_decode($documentos['titulo']);
   $contenidoPDF=utf8_decode($documentos['contenido']);
}
 ...
 $pdf->Cell(10,30,$tituloPDF); //Tamaño de la celda y su contenigo (tamaño en X, tamaño en Y, lo que será escrito)

 $pdf->SetFont("Arial","",13);
 $pdf->SetXY(28,40);
 $pdf->MultiCell( 143.5, 6, $contenidoPDF); //Multicell es VITAL ya que esto permite escribir varias líneas de texto en una sola celda. Paranetros(Posición en X, distancia de interlineado, lo que será escrito)
